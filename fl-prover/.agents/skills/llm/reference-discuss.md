...
```bash
python cli_tools/external.py discuss QUESTION [OPTIONS]
```
...
```bash
python cli_tools/external.py discuss "How should I approach this induction proof?" --backend gemini
python cli_tools/external.py discuss "What tactic should I use for this goal: ⊢ n + 0 = n" --backend gpt
cat stuck_proof.lean | python cli_tools/external.py discuss - --backend gemini
```
